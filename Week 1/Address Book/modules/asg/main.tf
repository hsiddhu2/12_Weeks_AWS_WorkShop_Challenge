...
resource "aws_iam_policy" "ReadSecretManagerUserPolicy" {
  name        = "ReadSecretUserPolicy"
  description = "ReadSecrets_UserPolicy"
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      {
...
#====================================
//Attach ReadSecrets_UserPolicy Policy to EC2 role
resource "aws_iam_role_policy_attachment" "ec2roleSSMpolicy" {
  role       = aws_iam_role.ec2role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}
#====================================
//Attach the above ReadSecretManagerUserPolicy to EC2 role
resource "aws_iam_role_policy_attachment" "ec2roleSecretManagerpolicy" {
  role       = aws_iam_role.ec2role.name
  policy_arn = aws_iam_policy.ReadSecretManagerUserPolicy.arn
}
#====================================
